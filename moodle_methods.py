...
def delete_test_user():
    ...
    sleep(0.25)
    driver.find_element(By.CSS_SELECTOR,'input#id_addfilter').click()
    if driver.find_element(By.XPATH,'f //td[contains(.,"{locators.email}")]').is_displayed():
        driver.find_element(By.XPATH,'//i@title="Delete"]').click()
        driver.find_element(By.LINK_TEXT,'Delete').click()
        print(f"New user'{locators.username}' has deleted")
    else:
        print (f" we need to check the code again")
